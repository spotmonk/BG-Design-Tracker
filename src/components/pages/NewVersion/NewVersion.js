    ...
    <div>
        <form>
          ...
          <label htmlFor="gameVersionOne">Game Version</label>
            ...
            <input type="number" min="0" class="form-control" id="gameVersionOne" onChange={changeGVOneEvent}/><h1>.</h1>
            <input type="number" min="0" class="form-control" id="gameVersionTwo" onChange={changeGVTwoEvent}/>
            </div>
          </div>
